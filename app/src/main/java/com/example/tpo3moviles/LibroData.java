...
public class LibroData {
    ...
    static {
        ...
        libros.add(new Libro(
                ...
                R.drawable.img1,
                new ArrayList<>(Arrays.asList("Infantil", "Fabula", "Ficcion", "Novela Corta", "Fantasia", "Aventura", "Magia"))));
        ...
        libros.add(new Libro(
                ...
                R.drawable.img2,
                new ArrayList<>(Arrays.asList("Fantasía", "Aventura", "Magia"))));
        ...
        libros.add(new Libro(
                ...
                R.drawable.img3,
                new ArrayList<>(Arrays.asList("Fantasía", "Guía", "Magia"))));
    }

    public static int buscarLibro(String titulo) {
        for (int i = 0; i < libros.size(); i++) {
            if (libros.get(i).getTitle().toLowerCase().contains(titulo.toLowerCase())) {
                return i;
            }
        }
        return -1;
    ...
    public static Libro buscarLibro(int indice) {
