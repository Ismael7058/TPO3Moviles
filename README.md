...
TPO3Moviles es una app mobile desarrollada en Java para Android que implementa el patrón de arquitectura **MVVM** (Model-View-ViewModel). Permite al usuario ingresar el título de un libro, buscarlo en un catálogo local y navegar a una pantalla de detalle con toda la información del libro encontrado.
...
1. Clona el repositorio:
   ```bash
   git clone https://github.com/Ismael7058/TPO3Moviles.git
   ```
2. Abre el proyecto en **Android Studio**.
3. Sincroniza las dependencias con Gradle.
4. Conecta un dispositivo o inicia un emulador con API 33 o superior.
5. Ejecuta la aplicación con **Run > Run 'app'** (⇧F10).
